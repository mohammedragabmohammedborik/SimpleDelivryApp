...
import com.mohammedragab.simpledelivryapp.databinding.PriceDetailsBinding


class PriceDetailsFragmentDialog: BottomSheetDialogFragment() {

    private var binding: PriceDetailsBinding?=null
    ...
    override fun onCreateView(
        ...
        binding = PriceDetailsBinding.inflate(
            inflater,
            container,
            false)
